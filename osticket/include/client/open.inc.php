...
?>
<h1><?php echo __('This is the form to Open a New Ticket');?></h1>
    ...
    <tr>
        ...
        <td>
            <select id="topicId" name="topicId" onchange="javascript:
                ...
                <option value="" selected="selected">&mdash; <?php echo __('Select any Help Topic');?> &mdash;</option>
                <?php
...
<hr/>
  <p style="text-align:center;">
        <input type="submit" value="<?php echo __('CLick here to Create Ticket');?>">
